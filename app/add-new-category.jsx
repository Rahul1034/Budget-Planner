...
export default function AddNewCategory() {
    ...
    const onCreateCategory = async () => {
        setLoading(true);
        if (!categoryName || !totalBudget || isNaN(totalBudget)) {
            ToastAndroid.show('Please enter valid category name and total budget.', ToastAndroid.SHORT);
            return;
        }
    ...
    return (
        <View style={{ marginTop: 20, padding: 20 }}>
            ...
            <ActivityIndicator color={Colors.WHITE}/>:  
                ...
                <Text style={{ textAlign: 'center', fontSize: 16, color: Colors.WHITE }}>
                    Create
                </Text>}
            </TouchableOpacity>
        </View>
